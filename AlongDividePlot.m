function AlongDividePlot(head_vals,varargin)
    ...
    % Optional Inputs:
    %       wl_method ['std_dev'] - switch to determine restrictiveness of criteria for defining whether a divide is stable, 'std_dev' uses the standard deviation 
    %           to determine if the means of a give metric overlap, alternatively 'std_err' uses the standard error, which is generally smaller than the standard deviation.
